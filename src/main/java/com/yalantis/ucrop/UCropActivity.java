...
public class UCropActivity extends AppCompatActivity {
    ...
    private void setAction(Intent intent) {
        String action = intent.getStringExtra(UCrop.ACTION);
        switch (action){
            case UCrop.ACTION_CROP:{
                setWidgetState(R.id.state_aspect_ratio);
//                changeSelectedTab(R.id.state_aspect_ratio);
//                setAllowedGestures(2);
                break;
            }
            case UCrop.ACTION_ROTATE:{
                setWidgetState(R.id.state_rotate);
//                changeSelectedTab(R.id.state_rotate);
//                setAllowedGestures(1);
                break;
            }
            case UCrop.ACTION_SCALE:{
                setWidgetState(R.id.state_scale);
//                changeSelectedTab(R.id.state_scale);
//                setAllowedGestures(0);
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mToolbarCancelDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CANCEL_DRAWABLE, R.drawable.ic_baseline_close_24);
        mToolbarCropDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CROP_DRAWABLE, R.drawable.ic_baseline_check_24);
