...
public class BitmapLoadTask extends AsyncTask<Void, Void, BitmapLoadTask.BitmapWorkerResult> {
    ...
    protected BitmapWorkerResult doInBackground(Void... params) {
        ...
        System.out.println("INPUT BAN DAU "+mInputUri);
        boolean decodeAttemptSuccess = false;
        while (!decodeAttemptSuccess) {
            try {
                InputStream stream;
//                if(mInputUri.toString().contains("file:///android_asset")){
//                    System.out.println("---------HHHHHHHHHHHHHHHHHH-------------"+mInputUri.toString().replace("file:///android_asset/",""));
//                     stream = mContext.getAssets().open(mInputUri.toString().replace("file:///android_asset/",""));
//                }else {
...
//                }
    ...
    private void processInputUri() throws NullPointerException, IOException {
        ...
        System.out.println("------------inputUriScheme-------------"+mInputUri);
